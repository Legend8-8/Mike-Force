...
[parseText format["<t font='RobotoCondensed' size='1.6'>%1</t><br /><t font='RobotoCondensed' size='1.0'>%2</t>",_nearestLocation,_gametime], true, nil, 7, 0.7, 0] spawn BIS_fnc_textTiles;
