/*
	File: fn_action_capture_player_tunnel.sqf
	Author: Cerebral
    modified: tylyervip
	Public: No

	Description:
		Capture an incapacitated opponent and send them to tunnel
...
[
	...
	format ["<t color='#0000FF'>%1</t>", localize 'STR_vn_mf_capture_player_tunnel'],							// Title of the action
	...
	{
		[cursorTarget, player, "mf_dc_spawnpoint_daccong_aotunnel"] remoteExec ["vn_mf_fnc_capture_player", 2];
