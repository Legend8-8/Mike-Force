/*
	File: fn_action_capture_travel_tunnel.sqf
	Author: Legend
    modified: tylyervip
	Public: No

	Description:
		Capture a incapacitated opponent and travel with them to tunnel
...
[
	...
	format ["<t color='#ffee00ff'>%1</t>", localize 'STR_vn_mf_capture_travel_tunnel'],							// Title of the action
	...
	{
		[cursorTarget, player, "mf_dc_spawnpoint_daccong_aotunnel"] remoteExec ["vn_mf_fnc_capture_travel", 2];
