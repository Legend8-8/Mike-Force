/*
	File: fn_action_capture_player_powcamp.sqf
	Author: Cerebral
    modified: tylyervip
	Public: No

	Description:
		Capture an incapacitated opponent and send them to POW camp
...
[
	...
	format ["<t color='#0000FF'>%1</t>", localize 'STR_vn_mf_capture_player_powcamp'],							// Title of the action
	...
	{
		[cursorTarget, player, "mf_dc_respawn_daccong_powcamp"] remoteExec ["vn_mf_fnc_capture_player", 2];
