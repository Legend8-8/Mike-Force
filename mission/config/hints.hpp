class CfgHints
{
	class Overview {
		...
		class Gamemode {
			...
			image = "ui\mikeforce\survivalcards\mission_strategy.paa";
		};
		...
		class Task_Roster {
			...
			//image = "ui\mikeforce\survivalcards\<cardname>.paa";
			//Note: No image
		};
		...
		class Gearing_Up {
			...
			image = "ui\mikeforce\survivalcards\arsenal.paa";
		};
		...
		class Fast_Travel {
			...
			image = "ui\mikeforce\survivalcards\map.paa";
		};
	...
	class Building {
		...
		class Overview {
			...
			image = "ui\mikeforce\survivalcards\build_menu.paa";
		};
		...
		class Placing {
			...
			image = "ui\mikeforce\survivalcards\ghost_building.paa";
		};
		...
		class Resupplying {
			...
			image = "ui\mikeforce\survivalcards\decay.paa";
		};
		...
		class Bases {
			...
			image = "ui\mikeforce\survivalcards\situation_room.paa";
		};
		...
		class Medical_Tent {
			...
			image = "ui\mikeforce\survivalcards\medical_tent.paa";
		};
		...
		class Checkpoint {
			...
			image = "ui\mikeforce\survivalcards\checkpoint.paa";
		};
	...
	class Deployment {
		...
		class Duty_Officer {
			...
			image = "ui\mikeforce\survivalcards\duty_officer.paa";
		};
	};
	...
	class Environment {
		...
		class Night {
			...
			image = "ui\mikeforce\survivalcards\FOB_flare.paa";
		};
	...
	class Gameplay {
		...
		class Respawning_Checkpoint {
			...
			image = "ui\mikeforce\survivalcards\checkpoint_supplies.paa";
		};
		...
		class Needs {
			...
			image = "ui\mikeforce\survivalcards\drink_food.paa";
		};
		...
		class Tasks {
			...
			image = "ui\mikeforce\survivalcards\AA.paa";
		};
		...
		class Logistics {
			...
			image = "ui\mikeforce\survivalcards\logistic_menu.paa";
		};
	...
	class Logistics {
		...
		class Supplies {
			...
			image = "ui\mikeforce\survivalcards\supply_officer.paa";
		};
		...
		class Wrecks {
			...
			image = "ui\mikeforce\survivalcards\wreck_packing.paa";
		};
	...
	class Team {
		...
		class Mike_Force {
			...
			image = "ui\mikeforce\survivalcards\mike_force.paa";
		};
		...
		class Green_Hornets {
			...
			image = "ui\mikeforce\survivalcards\green_hornet.paa";
		};
		...
		class ACAV {
			...
			image = "ui\mikeforce\survivalcards\acav.paa";
		};
	...
	class Artillery {
		...
		class RTO {
			...
			image = "ui\mikeforce\survivalcards\arty_support.paa";
		};
