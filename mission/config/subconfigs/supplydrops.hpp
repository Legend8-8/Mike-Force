class construction
{
	...
	icon = "ui\wheelmenu\img\icons\vn_ico_mf_sup_build_ca.paa";
...
class vehicles
{
	...
	icon = "ui\wheelmenu\img\icons\vn_ico_mf_truck_ca.paa";

	class WorkshopSupplies
	{
		name = "STR_vn_mf_workshop_supplies";
		className = "vn_b_ammobox_supply_06";
		icon = "ui\wheelmenu\img\icons\vn_ico_mf_sup_work_ca.paa";
	};
};
...
class support
{
	...
	icon = "ui\wheelmenu\img\icons\vn_ico_mf_sup_med_ca.paa";

	class FoodSupplies
	{
		name = "STR_vn_mf_food_supplies";
		className = "vn_b_ammobox_supply_02";
		icon = "ui\wheelmenu\img\icons\vn_ico_mf_sup_food_ca.paa";
		//crateName = "FoodCrate";
	};
...
class ammo
{
	...
	icon = "ui\wheelmenu\img\icons\vn_ico_mf_sup_ammo_ca.paa";
